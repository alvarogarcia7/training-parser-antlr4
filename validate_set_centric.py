#!/usr/bin/env python3
"""
Validate set-centric example with envelope against its schema.
"""
...
def validate_envelope_set_centric() -> int:
    """Validate the set-centric envelope example against its schema."""
    envelope_path = Path("data/set-centric-example.json")
    payload_schema_path = Path("schema/set-centric.schema.json")
...
if __name__ == "__main__":
    sys.exit(validate_envelope_set_centric())
